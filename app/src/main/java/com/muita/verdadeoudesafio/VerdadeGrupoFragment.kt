...
class VerdadeGrupoFragment : Fragment() {
    private lateinit var binding: FragmentVerdadeGrupoBinding
    ...
    override fun onCreateView(
        ...
        binding = FragmentVerdadeGrupoBinding.inflate(layoutInflater).apply {
            viewLifecycleOwner
        }
        initView()
        return binding.root
